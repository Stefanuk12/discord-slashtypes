...
exports.SubCommandGroup = exports.SubCommand = exports.Option = exports.Choice = exports.initialise = exports.removeAllSlashCommands = exports.OptionType = void 0;
const enums_1 = require("discord.js/typings/enums");
//
exports.OptionType = enums_1.ApplicationCommandOptionTypes;
/**
...
class SubCommand {
    // Constructor
    constructor(data) {
        this.type = enums_1.ApplicationCommandOptionTypes.SUB_COMMAND;
        this.name = data.name;
        this.description = data.description;
        // Check if options was given
        if (data.options) {
...
class SubCommandGroup extends Slash {
    constructor() {
        super(...arguments);
        this.type = enums_1.ApplicationCommandOptionTypes.SUB_COMMAND_GROUP;
    }
}
